...
void Input::key_callback(int key, int scancode, int action, int mods)
{
	...
	{
		case GLFW_KEY_1:
			keys.n1 = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_2:
			keys.n2 = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_3:
			keys.n3 = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_4:
			keys.n4 = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_5:
			keys.n5 = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_6:
			keys.n6 = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_7:
			keys.n7 = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_8:
			keys.n8 = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_9:
			keys.n9 = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_0:
			keys.n0 = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_LEFT_ALT:
			keys.leftAlt = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_ESCAPE:
			keys.escape = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_SPACE:
			keys.space = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_LEFT_SHIFT:
			keys.leftShift = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_RIGHT_SHIFT:
			keys.rightShift = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_LEFT_CONTROL:
			keys.leftCtrl = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_TAB:
			keys.tab = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_A:
			keys.a = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_B:
			keys.b = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_C:
			keys.c = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_D:
			keys.d = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_E:
			keys.e = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_F:
			keys.f = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_G:
			keys.g = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_H:
			keys.h = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_I:
			keys.i = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_J:
			keys.j = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_K:
			keys.k = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_L:
			keys.l = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_M:
			keys.m = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_N:
			keys.n = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_O:
			keys.o = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_P:
			keys.p = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_Q:
			keys.q = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_R:
			keys.r = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_S:
			keys.s = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_T:
			keys.t = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_U:
			keys.u = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_V:
			keys.v = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_W:
			keys.w = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_X:
			keys.x = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_Y:
			keys.y = (action == GLFW_PRESS);
			break;
		case GLFW_KEY_Z:
			keys.z = (action == GLFW_PRESS);
			break;
	}
}
